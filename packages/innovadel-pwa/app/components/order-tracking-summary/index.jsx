...
const OrderSummary = ({
    ...
    if (!basket?.c_orderData?.OrderSummary?.OrderNumber) {
        return null
    }
                ...
                <Stack w="full">
                    <Flex justify="space-between">
                        ...
                        <Text fontWeight="bold" fontSize={fontSize}>
                            <FormattedNumber
                                style="currency"
                                currency={basket?.c_orderData?.currency}
                                value={basket?.c_orderData?.OrderSummary?.TotalAdjustedProductAmount}
                            />
                        </Text>
                    </Flex>

                    {basket?.c_orderData?.orderPriceAdjustments?.map((adjustment) => (
                    ...
                    <Flex justify="space-between">
                        ...
                        {shippingItem?.priceAdjustments?.some(
                            ...
                            <Text fontSize={fontSize}>
                                <FormattedNumber
                                    value={basket?.c_orderData?.OrderSummary?.TotalDeliveryAmount}
                                    style="currency"
                                    currency={basket?.c_orderData?.currency}
                                />
                            </Text>
                    ...
                    <Flex justify="space-between">
                        ...
                        {basket?.c_orderData?.OrderSummary?.TotalTaxAmount != null ? (
                            <Text fontSize={fontSize}>
                                <FormattedNumber
                                    value={basket?.c_orderData?.OrderSummary?.TotalTaxAmount}
                                    style="currency"
                                    currency={basket?.c_orderData?.currency}
                                />
                            </Text>
                    ...
                    <Flex w="full" justify="space-between">
                        ...
                        <Text fontWeight="bold" fontSize={fontSize}>
                            <FormattedNumber
                                style="currency"
                                currency={basket?.c_orderData?.currency}
                                value={basket?.c_orderData?.OrderSummary?.GrandTotalAmount}
                            />
                        </Text>
                    </Flex>
