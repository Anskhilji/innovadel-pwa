...
const ProductDetail = () => {
    ...
    /**************** Custom start: Push product details into GTM dataLayer ****************/
    useEffect(() => {
        if (product) {
            const price = product?.c_promotionPrice?.value ?? product.price
    ...
    return (
        ...
        >
            ...
            <Stack spacing={6}> {/* Custom code for PDP page space between image and accordion */}
                {isProductASet ? (
                    <Fragment>
                    ...
                    <Fragment>
                        <ProductView
                            ...
                            isWishlistLoading={isWishlistLoading}
                        />
                            <Flex justify="left" flexDirection="column" >
                                <Flex justifyContent={'inherit'}>
                                <PaymentCards />
                                </Flex>
                            <Text fontSize="14px" fontWeight="500">
                                <FormattedMessage
                                    defaultMessage="10% off when paying by credit card"
                                    id="product_detail.recommended_products.title.complet"
                                />
                            </Text>
                            </Flex>
