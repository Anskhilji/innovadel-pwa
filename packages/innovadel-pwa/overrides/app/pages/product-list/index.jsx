...
// Custom start: imported local product-tile file
import ProductTile, {
...
// Custom start: import page header and above page header
...
const ProductList = (props) => {
    ...
    /**************** Custom start: Push product list impressions into GTM dataLayer ****************/
    useEffect(() => {
        if (productSearchResult) {
    ...
    return (
        ...
        >
            ...
            {showNoResults ? (
                ...
                <>
                    {/* Custom start: product tile above header */}
                    <AbovePageHeader categoryId={params.categoryId} />
                    {/* Custom end */}
                    {/* Header */}
                    <Stack
