...
import PromoCodeFields from '../forms/promo-code-fields'
...
export const PromoCode = ({form, submitPromoCode, itemProps}) => {
    ...
    useEffect(() => {
        if (!form.formState.isSubmitSuccessful && form.formState?.defaultValues?.code == '') {
            setOpen(false)
        }
                ...
                {({isExpanded}) => (
                    <>
                        ...
                        <AccordionPanel px={0} mb={4}>
                            ...
                            >
                                {/* Custom start: in this component we chaned button margin top */}
