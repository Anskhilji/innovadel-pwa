...
import '../../assets/svg/social-tiktok.svg'
import '../../assets/svg/creditcard.svg'
...
import PaypalSymbol from '../../../app/assets/svg/paypal.svg'
...
import ApplepaySymbol from '../../assets/svg/cc-applepay.svg'
import Remove from '../../../../app/assets/svg/remove.svg'
...
ApplepaySymbol.viewBox = ApplepaySymbol.viewBox || '0 0 38 22'
Remove.viewBox = Remove.viewBox || '0 0 38 22'
Checkmark.viewBox = Checkmark.viewBox || '0 0 38 22'
...
export const ApplepayIcon = icon('cc-applepay', {viewBox: ApplepaySymbol.viewBox})
export const RemoveIcon = icon('remove', {viewBox: Remove.viewBox})
export const CreditCard = icon('creditcard')
export const CheckmarkIcon = icon('checkmark', {viewBox: Checkmark.viewBox})
