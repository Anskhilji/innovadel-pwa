...
const Header = ({
    ...
    // Custom code for Search redesign for header
    const [isSearchVisible, setSeatchVisibility] = useState(false);
    const toggleSearch = () => {
        setSeatchVisibility(!isSearchVisible);
    }
