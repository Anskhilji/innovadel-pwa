...
import {Box, Flex, Button, Stack, Text, Heading, Divider, useMultiStyleConfig} from '@chakra-ui/react'
import {
    BasketIcon,
    ChevronDownIcon,
    ChevronUpIcon
...
const CartItems = ({basket}) => {
    ...
    return (
        <Stack spacing={5} width="full">
            ...
            {cartItemsExpanded && (
                <Stack spacing={5} align="flex-start" divider={<Divider borderColor="gray.1100" />}>
...
const OrderSummary = ({
    ...
    const styles = useMultiStyleConfig('OrderSummary')
    return (
        // Custom start: did some styling here for order summary
        <Stack data-testid="sf-order-summary" spacing={5}>
            <Heading fontSize={24} pt={1} {...styles.summaryHeading}>
                <FormattedMessage
            ...
            <Stack spacing={4} align="flex-start">
                ...
                <Stack w="full">
                    <Flex justify="space-between">
                        <Text {...styles.summaryLable}>
                            <FormattedMessage
                                defaultMessage="Subtotal"
                                id="order_summary.label.subtotal"
                            />
                        </Text>
                        <Text {...styles.summaryValue}>
                            <FormattedNumber
                                style="currency"
                    ...
                    <Flex justify="space-between">
                        <Flex alignItems="center">
                            <Text {...styles.summaryLable}>
                                ...
                                />
                                {hasShippingPromos && (
                                    <Text as="span" ml={1} {...styles.summaryLable}>
                                        (
                                        <FormattedMessage
